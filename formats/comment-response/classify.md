...
See `execute.md` in this same folder for the visual/production execution rules (casting, styling, sticker mechanic, design handoff). For the question, the reply copy, and how the argument should change by awareness stage, see `../../../scriptwriting/skills/comment-response/SKILL.md`.
